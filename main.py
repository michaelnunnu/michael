...
#                 print(df79.loc[(df79.trade_id==df99['trade_id'][0]), colname], file=sys.stderr)
            ...
            # elif True:
                ...
                print(order_complete[(order_complete['entry_time'].dt.date == datetime.datetime.now(pytz.timezone('Asia/Kolkata')).date()) & (order_complete['contract']=="P")].index, file=sys.stderr)
