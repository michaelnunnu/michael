...
#                 print(df79.loc[(df79.trade_id==df99['trade_id'][0]), colname], file=sys.stderr)
            ...
            print("price_break_C ",price_break_P, file=sys.stderr)
            print("last close price is ",price_check_P, file=sys.stderr)
